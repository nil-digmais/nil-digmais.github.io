(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(["../umd/rtcomm/connection","../umd/rtcomm/util"], function (a0,b1) {
      return (root['Paho'] = factory(a0,b1));
    });
  } else if (typeof exports === 'object') {
    // Node. Does not work with strict CommonJS, but
    // only CommonJS-like environments that support module.exports,
    // like Node.
    module.exports = factory(require("../umd/rtcomm/connection"),require("../umd/rtcomm/util"));
  } else {
    root['Paho'] = factory(rtcomm.connection,rtcomm.util);
  }
